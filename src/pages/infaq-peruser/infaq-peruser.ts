...
export class InfaqPeruserPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad InfaqPeruserPage');
  ...
  getLaporanInfaq()
  {
 	 ...
 	 this.restProvider.getLaporanGrafikUser(localStorage.getItem('usernameLogin'))
 			.then(data => {
 			 ...
 			 this.globalization.getPreferredLanguage()
 			  ...
 			  console.log('Laporan Total Infaqnya :'+this.dataLaporan.total_all);
        this.dataGraph = data;
        var labelBulan = [];
        var arrayTotalData = [];
